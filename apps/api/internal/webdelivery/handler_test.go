...
func TestOnlyPublicPagesAndFilesAreServed(t *testing.T) {
	...
	for path, status := range map[string]int{"/account/login": 200, "/account/register": 200, "/profiles": 200, "/help": 200, "/ranks": 200, "/games": 404, "/assets/app.js": 200, "/": 200, "/chat": 200, "/api/v1/missing": 404, "/assets/": 404, "/private.txt": 404, "/profiles/missing": 404} {
