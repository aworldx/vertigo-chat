...
func Mood(date string) string {
	...
	for _, d := range holiday[day.Month()] {
		if d == day.Day() {
			mood = "Сегодня праздник: ты особенно игрив, дружелюбен и щедр на остроумные наблюдения. Подхватывай настроение собеседника и охотно задавай уместные встречные вопросы."
		}
	}
