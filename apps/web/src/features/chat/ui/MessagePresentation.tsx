...
export function MessageTime({ message, className, id }: { message: Message; className: string; id?: string }) {
  return (
    <time id={`message-time-${id ?? String(message.id)}`} dateTime={message.sent_at} className={className}>
