...
await build({ entryPoints: ["src/app/main.tsx"], bundle: true, minify: !process.env.WEB_COVERAGE_DIR, sourcemap: process.env.WEB_COVERAGE_DIR ? "inline" : false, target: "es2022", outfile: "dist/assets/app.js", define: { "process.env.NODE_ENV": '"production"' } })
